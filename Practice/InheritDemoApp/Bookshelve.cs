...
class Booksselve : Furniture{
    ...
    public override void Display()
    {
      ...
      Console.WriteLine("color of shelves is :{0}",color);
      Console.WriteLine("width of shelves is :{0}",width);
      Console.WriteLine("height of shelves is :{0}",height);
